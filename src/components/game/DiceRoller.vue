...
.dot {
  ...
  border-radius: calc(var(--ratio) * 15px);
...
.side {
  ...
  text-align: center;
  line-height: calc(var(--ratio) * 1.5em);
}

.side:nth-child(1) {
  transform: translateZ(calc(var(--ratio) * 2.3em));
}

.side:nth-child(6) {
  transform: rotateY(90deg) translateZ(calc(var(--ratio) * 2.3em));
}
...
.side:nth-child(4) {
  transform: rotateX(90deg) translateZ(calc(var(--ratio) * 2.3em));
}
...
.side:nth-child(2) {
  transform: rotateY(-180deg) translateZ(calc(var(--ratio) * 2.3em));
}
